...
const hi = ["Hello there! My name is Aerosol and today I'm going to be teaching you about the severe impacts of Climate Change. This will be through an entertaining but informative simulation. Please type `$simulations` to continue."]
...
module.exports.run = async (client, message, args) => {
  message.channel.send('test', { files: ['lights.jpg'] });
};
client.on('message', msg => {
  if (msg.content.startsWith ('!image')) {
    msg.channel.send('An Image:', {files: ["./images/lights.jpg"]});
  }
});
